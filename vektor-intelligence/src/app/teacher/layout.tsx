...
const ACCENT        = "#7B5CFF";
const ACCENT_DIM    = "#7B5CFF20";
const ACCENT_BORDER = "#7B5CFF40";

const NAV = [
  { href: "/teacher",             label: "Overview",     sym: "⊞" },
  { href: "/teacher/heatmap",     label: "Live Heatmap", sym: "⬡" },
  { href: "/teacher/students",    label: "Students",     sym: "◈" },
  { href: "/teacher/assignments", label: "Assignments",  sym: "✦" },
  { href: "/teacher/history",     label: "Class History",sym: "◷" },
];
